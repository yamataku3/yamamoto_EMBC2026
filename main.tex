...
% \iffalse
  % Visualize
  \newcommand{\Add}[1]{\color{blue}{#1}\color{black}\relax}
  \newcommand{\Remove}[1]{\color{red}{\st{#1}}\color{black}\relax} % for English
  % \newcommand{\Remove}[1]{\color{red}{\sout{#1}}\color{black}} % for Japanese
  \newcommand{\ReviseFinish}[1]{\color{red}{\st{#1}}\color{black}\relax}
  \newcommand{\ReviseQuestion}[2]{\color{blue}{\st{#1}}\color{black}\relax}
\else
  % Finalize
  \newcommand{\Add}[1]{#1}
  \newcommand{\Remove}[1]{}
  \newcommand{\ReviseAdd}[1]{}
  \newcommand{\ReviseReplace}[2]{#2}
\fi
...
\begin{table}[t]
    \centering
    \caption{\textcolor{gray}{Hyperparameter search space in this study for CL methods.}}
...
\textcolor{red}{In the CIL scenario, most CL methods achieved higher accuracy than Naïve, except for GR on USC-HAD.
